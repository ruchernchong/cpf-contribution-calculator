...
describe("FAQ", () => {
  ...
  it("renders the correct number of FAQ items", () => {
    ...
    expect(screen.getByText("How is the CPF contribution calculated?")).toBeTruthy();
    expect(screen.getByText("What are the different CPF accounts?")).toBeTruthy();
  ...
  it("renders the correct answers for each question", () => {
    ...
    // Check for answers
    expect(screen.getByText(/The CPF Income Ceiling is the maximum amount/)).toBeTruthy();
    expect(screen.getByText(/CPF contributions are calculated based on your monthly ordinary wages/)).toBeTruthy();
    expect(screen.getByText(/The CPF consists of three main accounts/)).toBeTruthy();
    expect(screen.getByText(/Additional Wage refers to non-regular income/)).toBeTruthy();
    expect(screen.getByText(/This calculator provides estimates based on the official CPF contribution rates/)).toBeTruthy();
  });
