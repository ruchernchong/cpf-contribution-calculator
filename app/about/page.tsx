  ...
  <div className="max-w-4xl mx-auto p-6 space-y-8">
    <Card>
      ...
      <CardContent className="space-y-4">
        <p>
          The CPF Calculator is a user-friendly tool designed to help Singapore
          Citizens and Permanent Residents estimate their CPF contributions
          based on their income and age group.
        </p>
        <p>
          We keep our calculator updated with the latest CPF policies and income
          ceiling changes announced in the Singapore Budget 2023, ensuring
          accurate calculations for your financial planning needs.
        </p>
        <p>
    ...
    <Card className="border-orange-200 dark:border-orange-800 bg-orange-50 dark:bg-orange-950 dark:text-orange-200">
      ...
      <CardContent>
        <p>
          ...
          contribution calculations. It is not affiliated with, endorsed by, or
          officially connected to the Central Provident Fund Board (CPF Board),
          Ministry of Manpower (MOM), or any other government agency.
        </p>
        <p className="mt-4">
